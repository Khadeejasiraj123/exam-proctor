...
import ViewProctor from "./components/ViewProctor";
      ...
      <main>
        ...
        <Routes>
          <Route>
            ...
            <Route path="/viewProctor" element={<ViewProctor />} ></Route>
            <Route path="/viewStudent" element={<ViewStudent />} ></Route>
            <Route path="/allTest" element={<ViewTest />} ></Route>
            <Route path="/" element={<Home />} />
            <Route path="/login" element={<Login />} />
            <Route path="/register" element={<Registration isProtor={false} />} />
            <Route path="/forgot" element={<Forgot />} />
            <Route path="/change/:email" element={<Change />} />
            ...
            <Route element={<RequireAuth />}>
              ...
              <Route path="/proctor" element={<DashboardProctor />} />
